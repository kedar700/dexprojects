...
<h1 class="text-center">Welcome to Kedar's Dashboard</h1>
<style>
.icm-top{
	padding-top:12vw;
}
...
<div class="row icm-top">
	...
	<button class="btn btn-success icm-btn" >Cloudwatch Dashboard</button>
	</form>
	</div>
	<div class="col-md-4 text-center">
	<form action="rds.php">
   	<!-- <br /><input class="btn btn-primary btn-lg" type="button" value="Gallery"> -->
	   <button class="btn btn-success icm-btn">RDS Status</button>
	</form>
	</div>
	<div class="col-md-4 text-center">
	<form action="sqswatch.php">
	   <button class="btn btn-success icm-btn">SQS Status</button>
	</form>
	</div>
</div>
</body>
